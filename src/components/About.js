  ...
  return (
    <div className="py-8 px-4 bg-gray-100 mb-10">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
        <h2 className="text-blue-500 text-3xl font-bold text-center mb-8">About Us</h2>
          ...
          <div className="flex flex-col justify-between w-full md:w-1/2">
            <div className="flex flex-col justify-between h-full">
              <div className="p-6 bg-white rounded-lg shadow-md flex-1 mb-8 md:mb-4">
                <h3 className="text-blue-500 text-2xl font-semibold mb-2">Our Mission</h3>
              ...
              <div className="p-6 bg-white rounded-lg shadow-md flex-1">
                <h3 className="text-blue-500 text-2xl font-semibold mb-2">Our Vision</h3>
                <p className="text-gray-700 leading-relaxed">
