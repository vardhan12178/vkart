                    ...
                    {notifications.length > 0 ? (
                      notifications.map((item) => (
                        <div
                          ...
                          className={`
                            px-4 py-2.5 sm:px-5 sm:py-3 hover:bg-slate-50 transition-colors flex gap-3 sm:gap-4 border-b border-slate-50 last:border-0 cursor-pointer
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex justify-between items-start">
                              <p className={`text-xs sm:text-sm ${!item.isRead ? "font-bold text-slate-900" : "font-medium text-slate-700"}`}>
                                {normalizeNotificationTitle(item.title)}
                              </p>
                              <span className="text-[9px] sm:text-[10px] text-slate-400 whitespace-nowrap ml-2">{getTimeAgo(item.createdAt || Date.now())}</span>
                            </div>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <Avatar
                  ...
                  name={adminName}
                  email={adminEmail}
                  className="h-8 w-8 sm:h-9 sm:w-9 rounded-full ring-2 ring-white"
                  bgClassName="bg-[#a85d37] text-white"
                />
