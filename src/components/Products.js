...
const CardSkeleton = () => (
  <div className="rounded-3xl border border-gray-100 bg-white p-4 shadow-sm animate-pulse">
...
const QuickView = ({ product, onClose, onAdd }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative z-10 mx-4 w-full max-w-4xl overflow-hidden rounded-3xl bg-white shadow-2xl transition-all duration-300 animate-fadeIn">
        <button
          ...
          <div className="flex flex-col min-w-0">
            ...
            <div className="mt-auto pt-6">
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-amber-400 px-4 py-2 font-bold text-white shadow-[0_4px_14px_0_rgba(249,115,22,0.25)] transition-all duration-200 ease-in-out hover:brightness-110 hover:translate-y-[1px]"
              >
...
export default function Products() {
  ...
  useEffect(() => {
    ...
    if (priceRange.max !== 100000)
      next.set("max", String(priceRange.max));
...
const handleAddToCart = useCallback((product) => {
  ...
  return (
    <div
      className="container mx-auto px-4 py-8 overflow-x-clip  bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-orange-50 via-amber-50 to-white"
    ...
    >
        ...
        <div className="flex w-full min-w-0 flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
          <div className="order-1 flex w-full min-w-0 items-center gap-3 sm:order-2 sm:w-auto">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-orange-50 px-4 py-2 text-orange-700 ring-1 ring-orange-100 sm:hidden"
            >
              <FaFilter /> Filters
            </button>
          ...
          <div className="order-2 relative w-full min-w-0 sm:order-1 sm:w-72">
            ...
            <input
              ...
              className="w-full flex-1 min-w-0 rounded-xl border border-gray-200 bg-white px-10 py-2.5 text-sm outline-none transition placeholder:text-gray-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-100"
            />
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 min-w-0 transition-all">
          {loading ? (
            ...
            <div className="mx-auto mt-16 w-full max-w-md rounded-3xl border border-dashed border-gray-300 bg-white p-10 text-center">
              ...
              <button
                onClick={clearAll}
                className="mt-4 rounded-xl bg-gradient-to-r from-orange-500 to-amber-400 px-4 py-2 text-white shadow-[0_4px_14px_0_rgba(249,115,22,0.25)] hover:brightness-110"
              >
                Reset filters
              </button>
            </div>
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                {visibleItems.map((p) => {
                  ...
                  return (
                    <div
                      key={p.id}
                      className="group relative flex flex-col overflow-hidden rounded-3xl border border-gray-100 bg-white p-3 shadow-sm transition-all duration-300 hover:-translate-y-[3px] hover:shadow-xl hover:ring-1 hover:ring-orange-100"
                    >
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          alt={p.title}
                          loading="lazy"
                          className="h-56 w-full rounded-2xl bg-gray-50 object-contain transition duration-300 group-hover:scale-[1.03]"
                        />
                      ...
                      <div className="mt-3 flex items-center gap-2">
                        <button
                          ...
                          className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-amber-400 px-4 py-2 font-bold text-white shadow-[0_4px_14px_0_rgba(249,115,22,0.25)] transition-all duration-200 ease-in-out hover:brightness-110 hover:translate-y-[1px]"
                        >
                          <FaCartPlus /> Add to Cart
                        </button>
                        <button
              ...
              {visible < filteredProducts.length && (
                <div className="mt-10 flex justify-center">
                  <button
                    ...
                    className="rounded-xl border border-gray-300 px-5 py-2 text-sm font-medium text-gray-700 shadow-sm hover:border-orange-300 hover:text-orange-600 transition-all"
                  >
                    Load more
                  </button>
                </div>
      ...
      <button
        className="fixed bottom-6 right-6 flex items-center gap-2 rounded-full bg-gradient-to-r from-orange-500 to-amber-400 px-5 py-3 text-white font-semibold shadow-[0_4px_14px_0_rgba(249,115,22,0.25)] transition-all hover:scale-105 hover:brightness-110 z-50"
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className="rounded-xl bg-gradient-to-r from-orange-500 to-amber-400 px-4 py-2 text-sm font-bold text-white shadow-[0_4px_14px_0_rgba(249,115,22,0.25)] hover:brightness-110 hover:translate-y-[1px] transition-all"
              >
                Compare
              </button>
            </div>
