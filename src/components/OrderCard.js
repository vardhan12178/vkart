...
export default function OrderCard({ order }) {
  ...
  return (
    <div className={`group relative rounded-[2rem] border transition-all duration-300 overflow-hidden ${
      open 
          ...
          <div className="flex items-center justify-between lg:justify-end gap-6 lg:gap-10 border-t lg:border-t-0 border-gray-50 pt-4 lg:pt-0">
            ...
            <button 
              className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
                open ? "bg-gray-900 text-white rotate-180" : "bg-gray-100 text-gray-500 hover:bg-gray-200"
              }`}
            >
      ...
      <div className={`transition-all duration-500 ease-in-out overflow-hidden ${
        open ? "max-h-[1000px] opacity-100 border-t border-gray-100" : "max-h-0 opacity-0"
      }`}>
