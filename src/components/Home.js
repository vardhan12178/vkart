  ...
  return (
    <>
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center w-full max-w-6xl p-4 text-center">
          <h1 className="text-white text-4xl sm:text-5xl font-extrabold mb-4" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 1)' }}>
            Vkart
          </h1>
          <p className="text-white text-lg sm:text-xl mb-6" style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 1)' }}>
            Shop with us, we have the best products available online.
          </p>
          <Link to="/products">
            <button className="bg-transparent border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full shadow-lg hover:bg-white hover:text-indigo-700 transition duration-300 transform hover:scale-105">
              Shop Now
            </button>
          </Link>
        </div>
      ...
      <section className="bg-gray-50 py-8">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-gray-900">Why Shop With Us?</h2>
          <p className="text-gray-700 mb-8">Discover the benefits of shopping with us: quality products, exceptional customer service, and great deals.</p>
          <div className="flex flex-wrap justify-center">
            <div className="w-full sm:w-1/3 px-4 mb-8">
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 flex flex-col items-center">
                <img src="delivery-truck1.png" alt="Delivery Truck" className="w-12 sm:w-16 h-12 sm:h-16 mb-4" />
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-gray-900">Free Shipping</h3>
                <p className="text-gray-700 text-sm sm:text-base">Enjoy free shipping on all orders over $50. Fast and reliable delivery service.</p>
              </div>
            </div>
            <div className="w-full sm:w-1/3 px-4 mb-8">
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 flex flex-col items-center">
                <img src="badge.png" alt="Quality Products" className="w-12 sm:w-16 h-12 sm:h-16 mb-4" />
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-gray-900">Quality Products</h3>
                <p className="text-gray-700 text-sm sm:text-base">Our products are sourced from top brands and undergo strict quality control checks.</p>
              </div>
            </div>
            <div className="w-full sm:w-1/3 px-4 mb-8">
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 flex flex-col items-center">
                <img src="customer-support.png" alt="Customer Support" className="w-12 sm:w-16 h-12 sm:h-16 mb-4" />
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-gray-900">Customer Support</h3>
                <p className="text-gray-700 text-sm sm:text-base">We offer 24/7 customer support to assist you with any inquiries or issues.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-indigo-700 py-12 sm:py-16 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8">Join Our Newsletter</h2>
