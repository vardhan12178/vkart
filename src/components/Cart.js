      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                  <div className="flex items-start gap-5">
                    <img
                      ...
                      alt={item.title}
                      className="w-28 h-28 rounded-2xl object-contain border border-gray-100"
                    />
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-3 flex items-center gap-5">
                        ...
                        <div className="ml-auto text-right">
                          <div className="text-xl font-bold text-gray-900">{INR(lineSell)}</div>
                          {lineMrp > lineSell && (
          ...
          <aside className="lg:sticky lg:top-24 h-fit">
              ...
              <div className="p-5 space-y-3 text-sm">
                ...
                <div className="mt-4 flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300"
                  />
                  <button
                    onClick={applyPromo}
            ...
            {/* Wishlist */}
            <div className="mt-8 rounded-3xl bg-white shadow-xl overflow-hidden">
        ...
        {orderPlaced && (
          <div className="mt-12 bg-white p-8 rounded-3xl shadow-xl text-center">
