  ...
  return (
    <div className="p-4 mb-20">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
        <h2 className="text-gray-900 text-3xl font-bold mb-4 text-center">Contact Us</h2>
        <form onSubmit={handleSubmit} className="mt-4">
          ...
          <button type="submit" className="bg-gray-900 text-white px-4 py-2 rounded">Send Message</button>
        </form>
      </div>
    </div>
  );
